...
Pod::Spec.new do |s|
  ...
  s.name         = "zhifubaoSDK"
  s.version      = "0.0.1"
  s.summary      = "zhifubaoSDK is sort of tools for iOS develop"
  ...
  s.homepage     = "https://github.com/frankcjwen/zhifubaoSDK"
  ...
  #s.source       = { :git => "https://github.com/frankcjwen/zhifubaoSDK", :tag => "0.0.1" }
  s.source       = { :git => "https://github.com/frankcjwen/zhifubaoSDK.git" }
  ...
  s.framework  = "UIKit","SystemConfiguration","CFNetwork"
  # s.library   = "iconv"
